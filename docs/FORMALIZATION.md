...
- Handwritten analytic note:
  [proofs/leemfo_proofs.pdf](proofs/leemfo_proofs.pdf)
  ([TeX source](proofs/leemfo_proofs.tex)).
- Alectryon literate Lean (the machine-checked scripts):
  [alectryon/leemfo_alectryon.pdf](alectryon/leemfo_alectryon.pdf)
  ([source](alectryon/LeemFOProofs.lean)).
