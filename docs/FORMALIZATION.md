...
| `LeemFO/Inverse/LowRank.lean` | Rank-1 / TCC apply (`ihat_tcc`, `hybridCost`, `lineSearchCost`) |
| `LeemFO/Inverse/Homotopy.lean` | Exact quadratic homotopy, Born remainder, `mixedSpectrumPair` |
| `LeemFO/Inverse/LineSearch.lean` | Exact quartic line energy (`lineFid_quadEnergy`, `lineCubic_exactGN`) |
