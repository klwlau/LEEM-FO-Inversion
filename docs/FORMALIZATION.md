...
| `LeemFO/Inverse/LineSearch.lean` | Exact quartic line energy (`lineFid_quadEnergy`, `descentStep`, `exists_quadA2_ne_gn`) |
| `LeemFO/Inverse/Plane2.lean` | 2D stage-1 map (`stage1Pair2`, `vacuumGN_eq_stage1Pair2`) |
| `LeemFO/Inverse/Mix.lean` | End-to-end `mixed2D`; TIE / GS / Wiener / radial / JA witnesses |
