...
| `LeemFO/Inverse/SmallMode.lean` | Closed-form 1/2/3-mode and two-axis inverses (`ihat_twoMode`, `ihat_threeMode_axis`, `ihat_twoAxis`) |
| `LeemFO/Inverse/Degeneracy.lean` | `reflectLine`, `R_FO2_pureDefocus_perp` |
| `LeemFO/Inverse/Analytic.lean` | `analyticPsi`, `analyticPair_of_remainder`, `analyticPair_twoAxis`, `sampledR` |
| `LeemFO/Inverse/Fiber.lean` | `cisoidMass`, `recoveredMasses`, `transversalSupport`, `recoveredMasses_eq_gram_of_transversal` |
